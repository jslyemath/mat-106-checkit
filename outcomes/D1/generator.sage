...
# 1) The real path to the current generator.sage in your workspace:
real_sage = sys.argv[1]                  # e.g. "/workspaces/.../outcomes/EX1/generator.sage"
generator_dir   = os.path.dirname(real_sage)   # e.g. "/workspaces/.../outcomes/EX1"

# 2) The parent of that is exactly the "outcomes" folder where slye_math.py lives:
outcomes_dir = os.path.abspath(os.path.join(generator_dir, os.pardir))
...
module_globals = runpy.run_path(os.path.join(generator_dir, "pygenerator.py"))
