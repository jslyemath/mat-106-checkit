...
\begin{enumerate}
    \item If one \VAR{units_block} represents one, which type of block represents one tenth? Why? Relate your answer back to the base ten place value system.
    ...
    \item If one \VAR{units_block} represents one, which type of block represents one hundredth? Why? Relate your answer back to the base ten place value system.
