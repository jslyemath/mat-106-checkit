    ...
    def tikz_graphics(data):
        ...
        for part in ("p1", "p2", "p3"):
            ...
            if kind == "line":
                ...
                # here. The marked reference point is not always 1 -- p3 can
                # give a fraction such as 4/19 instead -- and labelling it "1"
                # made the picture state something false. Print read
                # label_b/label_c all along; the web drew its own and
                # disagreed, unnoticed while the two pictures were separate.
