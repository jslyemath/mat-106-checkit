...
Then, suppose the student challenged you to find \VAR{expl_how_many} numbers between the given two rational numbers. What would you do? (You do not need to write out \VAR{expl_how_many} individual numbers.)