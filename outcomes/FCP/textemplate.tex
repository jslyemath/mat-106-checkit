...
\begin{tabular}{lp{7.9cm}lp{7.9cm}}
    ...
    \numprob
    \#{ Less than the other blocks get. Ordering six integers is a single line
       of writing, not worked steps, so the 2in this started with was mostly
       empty paper. The slack also pays for the line of air under the header
       above, and leaves the sheet a little room to grow. }
    $\VAR{p18_prob}$ \newline\newline \ans{$\VAR{p18_ans}$} \\[1.35in]
\end{tabular}
