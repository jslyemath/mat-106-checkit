...
\begin{tabular}{lp{7.9cm}lp{7.9cm}}
    ...
    \numprob
    \#{ 1.8in, not 2in. The line of air added under the header above has to
       come from somewhere or problems 19 and 20 fall onto a third page; this
       is trailing space before the next instruction line rather than room a
       student writes in, so it is the cheapest 0.2in on the sheet. }
    $\VAR{p18_prob}$ \newline\newline \ans{$\VAR{p18_ans}$} \\[1.8in]
\end{tabular}
