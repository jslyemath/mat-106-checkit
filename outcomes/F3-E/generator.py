...
def generate(**kwargs):
    ...
    # random.choice takes one sequence; `choice(True, False)` raised
    # TypeError on every call, which is why this outcome has never
    # generated and is absent from the published bank.
